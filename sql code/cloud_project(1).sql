...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2025 at 08:34 PM
...
--
ALTER TABLE `f`
  MODIFY `file` int(7) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `users_id` int(7) NOT NULL AUTO_INCREMENT;
COMMIT;
